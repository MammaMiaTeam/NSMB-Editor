...
namespace NSMBe5
{
    ...
    public class ImageIndexer
    {
        ...
        public ImageIndexer(List<Bitmap> bl, bool useAlpha) : this(bl, 256, useAlpha, 0)
        {

        }

        public ImageIndexer(List<Bitmap> bl) : this(bl, 256, true, 0)
        {
        ...
        public ImageIndexer(List<Bitmap> bl, int paletteCount, bool useAlpha, int transpCol)
        {
            ...
            //Map The Original Colors To The Palette Entries!
            ...
            for (int t = 0; t < tileCount; t++)
                for (int y = 0; y < 8; y++)
                    for (int x = 0; x < 8; x++)
                    {
                        ...
                        palettedImage[t * 64 + y * 8 + x] = imageData[tx + x, ty + y];
            ...
            for (int t = 0; t < tileCount; t++)
                for (int y = 0; y < 8; y++)
                    for (int x = 0; x < 8; x++)
                    {
                        ...
                        palettedImage[t * 64 + y * 8 + x] = imageData[tx + x + px, ty + y + py];
